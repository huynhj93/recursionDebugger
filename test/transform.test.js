...
// var createObjectExpression = require('../lib/transform').createObjectExpression
...
// describe('Helpers for transform', function(){
// 	it('should be able to create object Expressions', function(){
// 		var whatIsThis = createObjectExpression({
// 	        type: true ? 'debugger' : 'step',
// 	        start: createObjectExpression(2),
// 	        end: createObjectExpression(5)
//       	});
//       	console.log('--------------------------------------');
//       	console.log(pp(whatIsThis));
//       	console.log('--------------------------------------');
//       	assert(true);
// 	})
// })
...
describe('non functions', function () {
  ...
  it('should yield before Statements', function () {
    var sourceStr =       fnString(function () {
        console.log(1);
        2;
        var x = 1;
        if (x) {
    ...
    var source = recast.parse(sourceStr);
var string = 
      fnString(function () {
        function *__top() {
          yield {
